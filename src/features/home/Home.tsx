...
export default function Home() {
  const { data, isLoading } = useQuery({ queryKey: ["featured"], queryFn: () => API.getFeaturedProducts(12) });
  ...
  return (
    <Layout>
      <section className="rounded-2xl bg-gradient-to-r from-indigo-50 to-blue-50 border p-6 mb-6">
        ...
        <p className="text-gray-600 mt-1">Independent reviews with pros/cons and clear verdicts.</p>
      </section>
